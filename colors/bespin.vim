" Vim color file
" Converted from Textmate theme Bespin using Coloration v0.2.2 (http://github.com/sickill/coloration)
...
" Цветовая схема для ColorColumn
if v:version >= 703
    hi ColorColumn guifg=NONE guibg=#2e2823
...
hi TabLineSel ctermfg=7 cterm=bold ctermbg=0

hi TabLineFill guibg=red guifg=#4c4a41
hi TabLineSel guifg=#cc7901 guibg=#2e2823
hi TabLine guifg=#cc7901 guibg=#2e2823

" fold colors
hi Folded cterm=bold ctermbg=0 cterm=none ctermfg=4
hi FoldColumn cterm=bold ctermbg=0 cterm=none ctermfg=4

" visual mode colors
hi Visual ctermbg=7 ctermfg=4

" dictionary menu colors
hi Pmenu ctermbg=7 ctermfg=0
hi PmenuSel ctermbg=1 ctermfg=0
hi CursorColumn cterm=bold ctermbg=0 cterm=none
hi CursorLine cterm=bold ctermbg=0 cterm=none
hi Search cterm=none ctermbg=7 ctermfg=4

hi Cursor guifg=#2E2841 guibg=#cc7901
...
"Line numbers color
hi LineNr cterm=bold ctermbg=0 cterm=none ctermfg=4
hi LineNr guifg=#cc7901 guibg=#4c4a41 gui=bold
...
hi Folded guibg=#2E2841 guifg=white
hi FoldColumn guibg=#28211c guifg=#FFFFFF
